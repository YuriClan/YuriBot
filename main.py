...
# embed = discord.Embed(title="Quote List Categories",
...
#     user = await client.fetch_user("722859224169709658")
...
#       await message.channel.send('Dont send that message again or actions would be taken! ')
...
# @client.slash_command(name = "test", description = "test slash command")
# async def test(interaction: Interaction):
#   await interaction.respond.send_message("Hey there buddy! u just used a slash command")
# @client.slash.slash(name="test", description="test slash command")
# async def test(ctx):
#     await ctx.send("Hey there buddy! You just used a slash command.")
